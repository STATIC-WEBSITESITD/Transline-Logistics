                        ...
                        <div className="row mt-50">
                            ...
                            <div className="col-lg-6">
                                ...
                                <div className="item-faqs-2 mb-30"><Link href="#">
                                    ...
                                    <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">A logistics provider is a company that specialises in providing logistics services, including transportation, storage, inventory management, and more.</p>
                                </div>
                            </div>
                        </div>
                    </div>
